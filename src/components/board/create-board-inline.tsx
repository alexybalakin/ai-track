...
export function CreateBoardInline({
  ...
  if (!isOpen) {
    return (
      <button
        ...
        className="w-full py-4 rounded-2xl border-2 border-dashed border-slate-200 hover:border-blue-300 hover:bg-blue-50/30 transition text-slate-400 hover:text-blue-500 flex items-center justify-center gap-2"
      >
        <svg
          className="w-5 h-5"
          fill="none"
  ...
  return (
    <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-5">
      <h3 className="font-semibold text-slate-900 mb-3">Create New Project</h3>
